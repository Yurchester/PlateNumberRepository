...
namespace PlateNumberRecognition.Vision.Logic.Engine
{
    public class TextRecognizer
    {
        ...
        public TextRecognizer(EulerContainer container)
            : this(new Approximator(), container, null, null) { }
        ...
        /// Создание экземпляра класса <see cref="TextRecognizer"/>.
        /// </summary>
        public TextRecognizer(IApproximator approximator, EulerContainer container, IFragmentAnalyzer analyzer, IScanner scanner)
        {
